...
export default function LoginPage() {
  return (
    <div className="relative min-h-screen bg-slate-950 flex items-center justify-center p-6 overflow-hidden">
      ...
      <Suspense fallback={
        <div className="relative z-10 w-full max-w-md bg-white/[0.02] border border-white/[0.06] backdrop-blur-xl rounded-3xl p-8 sm:p-10 shadow-2xl flex flex-col items-center justify-center min-h-[400px]">
